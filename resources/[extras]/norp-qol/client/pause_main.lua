    ...
    while true do
        ...
        if IsPauseMenuActive() then
            if not isPauseMenu then
              ...
              PushScaleformMovieFunctionParameterString(PlayerCharacterName)
              PushScaleformMovieFunctionParameterString((Config.cash_text):format(money.money)) 
              PushScaleformMovieFunctionParameterString((Config.bank_text):format(money.bank)) 
